...
class TopFreeAppsVC: BaseCollectionViewController, UICollectionViewDelegateFlowLayout {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.collectionView.register(TopFreeAppsViewCell.self, forCellWithReuseIdentifier: Constants.ReusableCellId.HomePageId)
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: Constants.ReusableCellId.HomePageId, for: indexPath) as! TopFreeAppsViewCell
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        .init(width: Constants.Dimensions.maxCellWidth, height: 300)
    }
...
extension TopFreeAppsVC: TopFreeAppsViewModelDelegate {
    ...
    func onErrorFetchingAppa(error: Error) {
